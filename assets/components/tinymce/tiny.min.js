...
if(z!==false){var oid=Ext.get(id);if(!oid)return;tinyMCE.execCommand('mceAddControl',false,id);}};MODx.unloadRTE=function(id){var editor=tinyMCE.get(id);if(editor)editor.remove();};MODx.afterTVLoad=function(){Tiny.onTVLoad();};MODx.unloadTVRTE=function(){Tiny.onTVUnload();};